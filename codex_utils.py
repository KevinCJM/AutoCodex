...
if __name__ == "__main__":
    cd_path = "/Users/chenjunming/Desktop/KevinGit/GienTechWork/CIB/CIB_wealth_manage"
    init_prompt = """记住:
1) 使用中文进行对话和文档编写;
2) 使用 "/Users/chenjunming/Desktop/myenv_312/bin/python3.12" 命令来执行python代码
    """
    (responses, agent_message, thread_id) = init_codex(init_prompt, cd_path)
    print(agent_message)
    resume_prompt = """深度理解以 local_test_3.py 为入口的代码全链路逻辑"""
    (_, agent_message, _) = resume_codex(thread_id, cd_path, resume_prompt)
    print(agent_message)
