...
def agent_prompt(
    *,
    ...
    def decorator(fn: Callable[..., str]) -> Callable[..., str]:
        setattr(fn, "__canopy_prompt_spec__", spec)
        return fn
...
def prompt_helper(*, no_turn: bool = True) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    def decorator(fn: Callable[..., Any]) -> Callable[..., Any]:
        setattr(fn, "__canopy_prompt_helper__", bool(no_turn))
        return fn
...
def copy_prompt_metadata(source: Callable[..., Any], target: Callable[..., Any]) -> Callable[..., Any]:
    ...
    if spec is not None:
        setattr(target, "__canopy_prompt_spec__", spec)
    if is_prompt_helper(source):
        setattr(target, "__canopy_prompt_helper__", True)
    return target
...
def get_prompt_spec(fn: Callable[..., Any]) -> PromptSpec | None:
    spec = getattr(fn, "__canopy_prompt_spec__", None)
...
def is_prompt_helper(fn: Callable[..., Any]) -> bool:
    return bool(getattr(fn, "__canopy_prompt_helper__", False))
