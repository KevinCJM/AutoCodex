# -*- encoding: utf-8 -*-
"""
@File: Prompt_04_DetailedDesign.py
...
def detailed_design(original_requirement_md='name_原始需求.md', requirements_clear_md='name_需求澄清.md',
                    hitl_record_md='name_人机交互澄清记录.md', detail_design_md='name_详细设计.md'):
    detailed_design_prompt = f"""## 任务
...
# [审核员] 评审详细设计文档
def review_detailed_design(agent_desc, task_name="name_详细设计", original_requirement_md='name_原始需求.md',
                           ...
                           detail_design_review_json='name_详设评审记录_agent.json'):
...
审计员已基于《{original_requirement_md}》+《{hitl_record_md}》+《{requirements_clear_md}》对比了你的《{detail_design_md}》。
...
if __name__ == '__main__':
    ...
    #                              hitl_record_md=f'{requirement_name}_人机交互澄清记录.md',
    #                              detail_design_md=f'{requirement_name}_详细设计.md',
    #                              detail_design_review_md=f"{requirement_name}_详设评审记录_Q.md",
    #                              detail_design_review_json=f"{requirement_name}_评审记录_Q.json"))
    ...
    if pass_bool:
        ...
        # 读取评审建议, 让需求分析师改
        ba_msg = get_markdown_content('/Users/chenjunming/Desktop/Canopy/canopy-api-v3/RealLifeCost_详设评审记录.md')
        ...
        #                                    hitl_record_md=f'{requirement_name}_人机交互澄清记录.md',
        #                                    detail_design_md=f'{requirement_name}_详细设计.md',
        #                                    detail_design_review_md=f'{requirement_name}_详设评审记录_C.md',
        #                                    detail_design_review_json=f'{requirement_name}_评审记录_C.json'))
