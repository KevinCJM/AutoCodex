...
# [主智能体] 通用输出与交互协议
def main_agent_workflow_after_review(ask_human_md='name_与人类交流.md', what_just_change='name_需求分析师反馈.md'):
...
2. **冲突消解**：若不同审核员的意见存在矛盾，必须继续已有文档记录和代码事实进行判定，并在元数据中记录你的取舍理由。
