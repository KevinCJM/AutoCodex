...
from tmux_core.requirements_scope import build_requirement_scope_lock_prompt
...
def main_agent_workflow_after_review(hitl_record_md=None,
                                     ask_human_md='name_与人类交流.md', what_just_change='name_需求分析师反馈.md'):
    # 有人类反馈信息
    if hitl_record_md:
...
if __name__ == '__main__':
    ...
    check_res = check_reviewer_job(['G1', 'G2', 'Q', 'CC'],
                                   directory="/Users/chenjunming/Desktop/Tmux/tmux-api-v3",
                                   task_name=task)
    if check_res:
        for i, m in check_res.items():
            ...
            print(m)
            print('-' * 100)
    check_res = check_develop_job('/Users/chenjunming/Desktop/Tmux/tmux-api-v3/工程师开发内容.md', task,
