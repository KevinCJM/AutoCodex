...
from canopy_core.stage_kernel.prompt_turns import (
...
class PromptContractSpecTests(unittest.TestCase):
            ...
            for node in ast.walk(tree):
                ...
                if isinstance(node, ast.Import):
                    for alias in node.names:
                        imported = alias.name
                        if imported.startswith("canopy_core.") and imported != "canopy_core.prompt_contracts.spec":
    ...
    def test_prompt_adapter_generates_appendix_and_must_change_baseline(self):
        ...
        from canopy_core.stage_kernel.development import build_developer_task_complete_result_contract
    ...
    def test_a07_ready_hitl_prompt_metadata_matches_legacy_init_contract_outcomes(self):
        ...
        from canopy_core.stage_kernel.development import build_developer_init_result_contract
