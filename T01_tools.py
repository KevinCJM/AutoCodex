...
from tmux_core.runtime.contracts import normalize_review_status_payload
...
if __name__ == "__main__":
    # create_empty_json_files(directory="/Users/chenjunming/Desktop/Tmux/tmux-api-v3",
    #                         name_list=['G1', 'G2', 'Q', 'CC'],
    #                         pattern="代码评审记录_*.json")
    task = "M4-T2"
    print(get_first_false_task('/Users/chenjunming/Desktop/Tmux/tmux-api-v3/任务单.json'))
    print(task_done(directory="/Users/chenjunming/Desktop/Tmux/tmux-api-v3",
                    file_path='/Users/chenjunming/Desktop/Tmux/tmux-api-v3/任务单.json',
                    task_name=task,
                    json_pattern="代码评审记录_*.json",
                    md_pattern="代码评审记录_*.md", md_output_name="代码评审记录.md"))

    print(check_string_in_markdown('/Users/chenjunming/Desktop/Tmux/tmux-api-v3/工程师开发内容.md', task))
